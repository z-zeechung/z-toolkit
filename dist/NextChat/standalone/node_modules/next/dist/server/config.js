...
function assignDefaults(dir, userConfig, silent) {
    var _defaultConfig_experimental, _result_experimental, _result_experimental1, _result_experimental2, _result_experimental3, _result_experimental4, _result_experimental_serverActions, _result_experimental5, _result_experimental6, _result_experimental7, _result_experimental8, _result_experimental9, _result_devIndicators, _result_experimental10;
    ...
    if (((_result_experimental = result.experimental) == null ? void 0 : _result_experimental.ppr) && !"14.1.1".includes("canary") && !process.env.__NEXT_TEST_MODE) {
    ...
    if (((_result_experimental7 = result.experimental) == null ? void 0 : _result_experimental7.useDeploymentId) && process.env.NEXT_DEPLOYMENT_ID) {
        if (!result.experimental) {
            result.experimental = {};
        }
    ...
    if ((_result_experimental8 = result.experimental) == null ? void 0 : _result_experimental8.useDeploymentIdServerActions) {
        result.experimental.useDeploymentId = true;
    }
    // use the closest lockfile as tracing root
    if (!((_result_experimental9 = result.experimental) == null ? void 0 : _result_experimental9.outputFileTracingRoot)) {
    ...
    const userProvidedOptimizePackageImports = ((_result_experimental10 = result.experimental) == null ? void 0 : _result_experimental10.optimizePackageImports) || [];
    if (!result.experimental) {
        result.experimental = {};
    }
